...
# Пути к фото
PHOTO_NORMAL_PATH = os.path.join(BASE_DIR, "photos", "окак.jpg")
PHOTO_EXTINGUISHER_PATH = os.path.join(BASE_DIR, "photos", "чертик.jpg")
PHOTO_TAXI_PATH = os.path.join(BASE_DIR, "photos", "такси.jpg")
PHOTO_ACCOUNTANT_PATH = os.path.join(BASE_DIR, "photos", "бухгалтер.jpg")
PHOTO_GANG_PATH = os.path.join(BASE_DIR, "photos", "банды.jpg")
PHOTO_CASINO_PATH = os.path.join(BASE_DIR, "photos", "казино.jpg")
PHOTO_FLOWER_WITH_EXTINGUISHER = os.path.join(BASE_DIR, "photos", "цветок_с_огнетушителем.jpg")
PHOTO_FLOWER_WITHOUT_EXTINGUISHER = os.path.join(BASE_DIR, "photos", "чертик.jpg")
